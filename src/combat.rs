...
use crate::{GameState, ascii::{AsciiSheet, spawn_ascii_sprite, spawn_ascii_text, AsciiText, NineSliceIndices, spawn_nine_slice}, fadeout::create_fadeout, player::Player, TILE_SIZE, RESOLUTION};
...
fn spawn_combat_menu(
    ...
    let fight_center_x = RESOLUTION - (run_width * TILE_SIZE) / 2.0;
